...
public class MentalSnakesMainActivity extends Screen {
    ...
    private int height;
    private Graphics g;
    private String versionNumber = "0.1.2";
    ...
    {    	
        ...
        screen = new GameScreen(new Grid (gridX, gridY, width - 2 * gridX, 5, 10), new Backdrop (width, height, 240, 240, 240));
    ...
    public void update(float deltaTime) 
    {
        ...
        screen.refresh(touchevents, g, font, FONT_SIZE, STROKE_WIDTH, 0, 100, 90, 180, versionNumber);
    }
