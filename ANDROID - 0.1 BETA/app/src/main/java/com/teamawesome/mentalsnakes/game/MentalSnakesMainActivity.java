...
public class MentalSnakesMainActivity extends Screen {
    ...
    public void addScreenDirectionMenu()
    {
        ...
        Button buttonNorth = new MoveButton (1, 0, Direction.UP);
        menuDirection.addButton(buttonNorth);
        Button buttonWest = new MoveButton (0, 1, Direction.LEFT);
        menuDirection.addButton(buttonWest);
        Button buttonSouth = new MoveButton (1, 2, Direction.DOWN);
        menuDirection.addButton(buttonSouth);
        Button buttonEast = new MoveButton (2, 1, Direction.RIGHT);
    ...
    public void addScreenResetButton()
    {
        ...
        Button resetButton = new ResetButton(0, 0);
