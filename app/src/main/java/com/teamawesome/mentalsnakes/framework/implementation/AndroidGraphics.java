...
public class AndroidGraphics implements Graphics 
{
	...
	@Override
	public void drawRoundRect(int x, int y, int width, int height, int curve, int color)
	{
		paint.setColor(color);
		paint.setStyle(Style.FILL);
		canvas.drawRoundRect(x, y, x + width - 1, y + height - 1, curve, curve, paint);
	}
	...
	@Override
	public void drawText(String text, Typeface font,int x, int y, int size, int strokeWidth, int color)
	{
		paint.setColor(color);
